...
import backstage.webcrawler.newsparser.impl.NewsParserImpl;
...
public class HTMLDocumentParser implements DocumentParser {
    ...
    public ProcessedDocument parse(FetchedDocument doc) 
        ...
        try {
        	...
        	System.out.println("HTMLDocumentParser.parse:UnsupportedEncodingException: " + e);
    ...
    private void parseHTML(ProcessedDocument htmlDoc, InputSource inputSource) 
        ...
        if(DOMContentUtils.isSubjectPage(node, htmlDoc.getDocumentURL())){
        	//add by raoxunrong, begin
            NewsParser newsParser = new NewsParserImpl();
            newsParser.extractNews("", node, true);
            //add by raoxunrong, end
        }
