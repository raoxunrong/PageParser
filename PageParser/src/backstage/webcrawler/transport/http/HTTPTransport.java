...
public class HTTPTransport implements Transport {
	...
	private FetchedDocument createDocument(String targetURL, GetMethod httpget)
		 ...
		 */
		int MAX_DOCUMENT_LENGTH = 1024 * 1024; // 512K
		...
		if (contentEncodingHeader != null) {
			// add by raoxunrong, for handle gzip info ---- begin
			if ("gzip".equals(contentEncodingHeader.getValue())) {
				InputStream inputStream = new GZIPInputStream(httpget
				...
				// add by raoxunrong, for handle gzip info ---- end
		 ...
		 */
		String DEFAULT_CONTENT_CHARSET = "GBK";// modify by raoxunrong,
													// original is UTF-8
